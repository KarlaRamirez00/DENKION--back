...
class Cliente(models.Model):
    ...
    apellido_paterno  = models.CharField(max_length=60, blank=False, null=False)
    apellido_materno  = models.CharField(max_length=60, blank=False, null=False)
    fec_nac           = models.DateField(blank=False, null=False)  
    telefono          = models.IntegerField(blank=False, null=False)
    direccion         = models.CharField(max_length=100, blank=False, null=False)
    comuna            = models.CharField(max_length=60, blank=False, null=False)
    ciudad            = models.CharField(max_length=60, blank=False, null=False)
