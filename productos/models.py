...
class Producto(models.Model):
    ...
    def __str__(self):
        return str(self.rut)+" "+str(self.nombre)+" "+str(self.apellido_paterno)+" "+str(self.apellido_materno)+" "+str(self.producto.id_producto)
    ...
    class Boleta(models.Model):
        ...
        def cliente_info(self):
            return str(self.cliente.rut)+" "+(self.cliente.nombre)+" "+(self.cliente.apellido_paterno)

        def producto_info(self):
            return str(self.producto.id_producto)+" "+(self.producto.marca)+" "+(self.producto.modelo)
